...
ALTER TABLE staging.stg_sessions
DROP COLUMN session_start_time, session_end_time, user_id, order_id, campaign_id, traffic_source;

ALTER TABLE staging.stg_order_items
DROP COLUMN shipping_fee_item, maintenance_amount;
